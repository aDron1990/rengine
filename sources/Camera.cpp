...
void Camera::move(Direction dir) noexcept
{
    ...
    case Direction::Front:
        m_position += glm::normalize(glm::vec3 { m_front.x, 0.0f, m_front.z }) * m_deltaTime * m_speed;
        break;
    case Direction::Back:
        m_position -= glm::normalize(glm::vec3 { m_front.x, 0.0f, m_front.z }) * m_deltaTime * m_speed;
        break;
    case Direction::Left:
        m_position -= glm::normalize(glm::cross(m_front, m_up)) * m_deltaTime * m_speed;
        break;
    case Direction::Right:
        m_position += glm::normalize(glm::cross(m_front, m_up)) * m_deltaTime * m_speed;
        break;
    case Direction::Up:
        m_position += m_up * m_deltaTime * m_speed;
        break;
    case Direction::Down:
        m_position -= m_up * m_deltaTime * m_speed;
        break;
